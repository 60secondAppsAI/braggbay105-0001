...
import ItemCategorys from  '@/pages/ItemCategorys.vue';
import ItemCategoryDetail from  '@/pages/ItemCategoryDetail.vue';
...
let routes = [
	...
	{
	    path: '/itemCategory/:itemCategoryId', 
	    name: 'ItemCategoryDetail',
		layout: "dashboard",
	    component: ItemCategoryDetail,
	    props: true // Pass route params as props to the component
  	},
	{
