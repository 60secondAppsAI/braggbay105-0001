						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="ItemName" type="text" placeholder="Enter ItemName" v-model="itemToAdd.itemName"></base-input>
								  <base-input label="Description" type="text" placeholder="Enter Description" v-model="itemToAdd.description"></base-input>
								  <base-input label="Price" type="text" placeholder="Enter Price" v-model="itemToAdd.price"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Item Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Item Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ItemName" type="text" placeholder="Enter ItemName" v-model="itemDetails.itemName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					...
					<td class="detail_view_column_2">Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Price" type="text" placeholder="Enter Price" v-model="itemDetails.price"></input>
																		</div>
						</td>
														</tr>
