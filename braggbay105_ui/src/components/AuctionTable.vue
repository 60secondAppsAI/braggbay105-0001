...
<template>
  ...
  <base-input label="StartDate" type="text" placeholder="Enter StartDate" v-model="auctionToAdd.startDate"></base-input>
  <base-input label="EndDate" type="text" placeholder="Enter EndDate" v-model="auctionToAdd.endDate"></base-input>
